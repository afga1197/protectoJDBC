...
<html>
    ...
    <script src="assets/JS/validarAdd.js"></script>
	...
	<body style="background-color: white">
        ...
        <div id="login_title">
            ...
            <h1 class="mbr-title pt-2 mbr-fonts-style display-2" style="text-align: center" id="main_title">
                <b style="color: #ffffff">&nbsp;&nbsp;&nbsp;Registro de usuarios<br></b></h1>
        </div>
            <br><br>   
        <div >
            ...
            <form:form action="guardarUsuario" method="post" modelAttribute="usuario" name="FaddEdit" onsubmit="return validarAdd()" >
               <div class="col-md-6  form-group"  id="TextF">
                    <form:input id="txtUser" path="User" placeholder="Usuario" required="required" class="form-control input display-7" /> 
                </div>
                <br><br>

                <div class="col-md-6  form-group"  id="TextF">
                    <form:input id="txtEmail"  path="Email" placeholder="email" required="required" class="form-control input display-7"/> 
                </div>
                <br><br>
                
                <div class="col-md-6  form-group"  id="TextF">
                    <form:input id="txtPass" style="background: #eeeeee"  type="password" path="Password" placeholder="Contraseña" required="required" class="form-control input display-7" /> 
                </div>
                <br><br>
                <div class="col-md-6  form-group"  id="TextF">
                    <div class="g-recaptcha" data-sitekey="6LdXdcEUAAAAAAL2LyLeMLMcpxGOLXBbLgbSLZ1Q"></div>
                </div>
                    <form:input path="Web_ID" type="hidden" name="txtWeb_ID" value="1"/>
                    <form:input path="Role" type="hidden" name="txtRole" value="69"/>
                <br><br>
                <c:if test="${ERROR_MESSAGE != null}">
                    <div><br><br>
                        <h3 class="section-content-title pb-3 align-left mbr-fonts-style display-5"  style="text-align: center;color: #ff0000">
                        <b>${ERROR_MESSAGE}<br></b></h3>
                    </div>
                </c:if> 
                 <br>
                <button  type="submit" class="button_green" ><strong>Registrar</strong></button><br><br>
            </form:form>
