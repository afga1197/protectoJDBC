<%-- 
    Document   : editUser
    Created on : 07/09/2019, 08:48:33 PM
    Author     : Toshiba
--%>
    ...
    <body>
        ...
        <div id="login_title">
            ...
            <h1 class="mbr-title pt-2 mbr-fonts-style display-2" style="text-align: center" id="main_title">
                <b style="color: #ffffff">&nbsp;&nbsp;&nbsp;Editar informaci&oacute;n<br></b></h1>
        </div>
        <br><br>   
        <div >
        ...
        <form:form action="modificarUsuario" method="post" modelAttribute="usuario" name="FaddEdit" onsubmit="return validarEdit()">
            <div class="col-md-6  form-group"  id="TextF">
                <form:input id="txtUser" path="User" value="${user.getUser()}" placeholder="Usuario" required="required" class="form-control input display-7" /> 
            </div>
            <br><br>

            <div class="col-md-6  form-group"  id="TextF">
                <form:input id="txtEmail"  path="Email" value="${user.getEmail()}" placeholder="email" required="required" class="form-control input display-7"/> 
            </div>
            <br><br>

            <div class="col-md-6  form-group"  id="TextF">
                <form:input id="txtPass" style="background: #eeeeee" value="${user.getPassword()}" type="password" path="Password" placeholder="Contraseña" required="required" class="form-control input display-7" /> 
            </div>
            <br><br>
            <form:input path="Id" type="hidden" name="txtid" value="${user.getId()}"/>
            <form:input path="Web_ID" type="hidden" name="txtWeb_ID" value="${user.getWeb_ID()}"/>
            <form:input path="Role" type="hidden" name="txtRol" value="${user.getRole()}"/>
