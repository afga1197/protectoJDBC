<%-- 
    ...
    Created on : 22/10/2019, 09:46:21 AM
    Author     : sala3
--%>
...
<html>
    <head>
        ...
        <title>Actualidad del cambio clim&aacute;tico</title>
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12" style="margin-top: -20%;">
                        <div id="tyt_wdgt_1572361352330" style="overflow:hidden;width:500px;height:415px;position: relative; display: block; margin-left: auto; margin-right: auto;" data-options="color=gris&text=txt-verdana&content=1111111&temp_unit=c&wind_unit=kmh">
                            <script src="http://tiempoytemperatura.es/widgets/js/biggest-6day/3688689/tyt_wdgt_1572361352330/?v=0"></script>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
            var typed = new Typed(".typed-words", {
                strings: ["Cuidemos el medio ambiente", "Ayuda a tu planeta"],
                typeSpeed: 60,
                backSpeed: 60,
                backDelay: 4000,
                startDelay: 1000,
