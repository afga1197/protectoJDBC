<%-- 
    Document   : configGeofisico
    Created on : 30/10/2019, 07:36:00 PM
    Author     : Toshiba
--%>
...
<html>
    <head>
        ...
        <title>Gestión modulo D. geofísicos</title>
                    ...
                    <div class="col-12 col-md-12">
                        <div class="media-container-row">
                            ...
                            <div class="mbr-figure">
                                ...
                                <textarea class="form-control" id="exampleFormControlTextarea3" rows="7" id="center_TA">${Cuadros[0].getTexto()}</textarea>
                            </div>                             
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-md-12">
                        <div class="media-container-row">
                            ...
                            <div class="mbr-figure">
                                <h4 class="mbr-title pt-2 mbr-fonts-style display-5" style="text-align: center;">
                                    <b>Texto Actual<br></b></h4>
                                <textarea class="form-control" id="exampleFormControlTextarea3" rows="7" id="center_TA">${Cuadros[5].getTexto()}</textarea>
                            </div>                             
                        </div>
                    </div>
                </div>
