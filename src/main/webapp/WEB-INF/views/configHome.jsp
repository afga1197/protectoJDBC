<%-- 
    Document   : configHome
    Created on : 29/10/2019, 07:45:18 PM
    Author     : Toshiba
--%>
                    ...
                    <div class="card p-3 col-12 col-md-6 col-lg-4">
                        <form:form action="modificarInfoCuadro" method="post" modelAttribute="cuadro" name="FE_1"  >
                            <div class="card-img pb-3">
                                <h4 class="mbr-title pt-2 mbr-fonts-style display-5" style="text-align: center;">
                                <b>Imagen<br></b></h4>  
                                <form:input path="Imagen" type="text" class="form-control input display-7" id="center_TA"  name="txtImagen" value="${Cuadros[1].getImagen()}"/>
                            </div>
                            <div class="card-box">
                    ...
                    <div class="card p-3 col-12 col-md-6 col-lg-4">
                        <form:form action="modificarInfoCuadro" method="post" modelAttribute="cuadro" name="FE_1"  >
                            <div class="card-img pb-3">
                                <h4 class="mbr-title pt-2 mbr-fonts-style display-5" style="text-align: center;">
                                <b>Imagen<br></b></h4>  
                                <form:input path="Imagen" type="text" class="form-control input display-7" id="center_TA"  name="txtImagen" value="${Cuadros[3].getImagen()}"/>
                            </div>
                            <div class="card-box">
                                <h4 class="card-title py-3 mbr-fonts-style display-5" style="text-align: center" >Subtitulo</h4>
                    ...
                    <div class="col-12 col-md-12">
                        <div class="media-container-row">
                            <div class="media-content">
                                <div class="mbr-section-text">
                                    <form:form action="modificarInfoCuadro" method="post" modelAttribute="cuadro" name="FE_1"  >
                                        ...
                                        <form:input path="Seccion_ID" type="hidden" name="txtSeccion" value="${Cuadros[4].getSeccion_ID()}"/>
                                        ...
                                        <form:input path="Modulo_ID" type="hidden" name="txtModulo_ID" value="${Cuadros[4].getModulo_ID()}"/>
                                        <span class="vspacer"></span><br><br>
                                        <button  type="submit" class="button_green" style="position: relative;top:320px;" ><strong>Modificar</strong></button><br><br>
                                    </form:form>
                                </div>
                            ...
                            <div class="mbr-figure">
                                <h4 class="mbr-title pt-2 mbr-fonts-style display-5" style="text-align: center;">
                                <b>Texto Actual<br></b></h4>
                                <textarea class="form-control"  rows="7" id="center_TA">${Cuadros[4].getTexto()}</textarea>
                            </div>                             
                        </div>
                    </div>
                </div>
                ...
                <div class="row pt-5 mt-5">
                    <div class="col-md-6 text-elements">
                        <form:form action="modificarInfoCuadro" method="post" modelAttribute="cuadro" name="FE_1"  >
                            ...
                            <h4 class="mbr-title pt-2 mbr-fonts-style display-5" style="text-align: center;">
                            <b>Texto actual<br></b></h4>
                            <textarea class="form-control"  rows="7" id="center_TA">${Cuadros[6].getTexto()}</textarea>
                            <span class="vspacer"></span>
                            <br>
                            <h4 class="card-title py-3 mbr-fonts-style display-5" style="text-align: center" >Nuevo texto</h4>
                            <p style="text-align: center">"Si no desea modificar copie el texto actual"</p>  
                            <form:textarea id="center_TA" class="form-control"  rows="7" path="Texto" type="text" name="txtTexto" required="true" />   
                            ...
                            <form:input path="Imagen" type="hidden" name="txtImagen" value="${Cuadros[6].getImagen()}"/>
                    ...
                    <div class="progress_elements col-md-6">
                        <form:form action="modificarInfoCuadro" method="post" modelAttribute="cuadro" name="FE_1"  >
                            ...
                            <h4 class="mbr-title pt-2 mbr-fonts-style display-5" style="text-align: center;">
                            <b>Grafica<br></b></h4> 
                            <form:input path="Grafica" type="text" class="form-control input display-7" id="center_TA"  name="txtSub" value="${Cuadros[7].getGrafica()}"/>
                            ...
                            <form:input path="Texto" type="hidden" name="txtTexto" value="${Cuadros[7].getTexto()}"/>
                            <form:input path="Imagen" type="hidden" name="txtImagen" value="${Cuadros[7].getImagen()}"/>
