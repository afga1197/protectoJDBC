<%-- 
    Document   : configBiologico
    Created on : 30/10/2019, 07:36:16 PM
    Author     : Toshiba
--%>
...
<html>
    <head>
        ...
        <title>Gestión modulo D.biológicos</title>
    ...
    <body>
        ...
        <div class="container" id="main_title">
            <h2 class="mbr-title pt-2 mbr-fonts-style display-2"  style="text-align: center">
                <b>&nbsp;&nbsp;&nbsp;Gestión modulo D. Geofísicos<br></b></h2>
        </div>
        <br><br>
        <div class="container" id="main_title">
                    ...
                    <div class="card p-3 col-12 col-md-6 col-lg-4">
                        <form:form action="modificarInfoCuadro" method="post" modelAttribute="cuadro" name="FE_1"  >
                            <div class="card-img pb-3">
                                <h4 class="mbr-title pt-2 mbr-fonts-style display-5" style="text-align: center;">
                                    <b>Video<br></b></h4>  
                                        <form:input path="Video" type="text" class="form-control input display-7" style="width: 300px;display: block; margin-left: auto; margin-right: auto;"  name="txtVideo" value="${Cuadros[1].getVideo()}"/>
                            </div>
                            <div class="card-box">
                                <h4 class="card-title py-3 mbr-fonts-style display-5" style="text-align: center" >Subtitulo</h4>
                                <form:input path="Subtitulo" type="text" class="form-control input display-7" style="width: 300px;display: block; margin-left: auto; margin-right: auto;"  name="txtImagen" value="${Cuadros[1].getSubtitulo()}"/>
                        ...
                        <form:form action="modificarInfoCuadro" method="post" modelAttribute="cuadro" name="FE_1"  >
                            <div class="card-img pb-3">
                                <div class="mbr-figure">
                                    <h4 class="mbr-title pt-2 mbr-fonts-style display-5" style="text-align: center;">
                                        <b>Video<br></b></h4>  
                                            <form:input path="Video" type="text" class="form-control input display-7" style="width: 300px;display: block; margin-left: auto; margin-right: auto;"  name="txtVideo" value="${Cuadros[2].getVideo()}"/>
                                </div>                              
                            </div>
                            <div class="card-box">
                                <h4 class="card-title py-3 mbr-fonts-style display-5" style="text-align: center" >Subtitulo</h4>
                    ...
                    <div class="card p-3 col-12 col-md-6 col-lg-4">
                        <form:form action="modificarInfoCuadro" method="post" modelAttribute="cuadro" name="FE_1"  >
                            <div class="card-img pb-3">
                                <h4 class="mbr-title pt-2 mbr-fonts-style display-5" style="text-align: center;">
                                    <b>Video<br></b></h4>  
                                        <form:input path="Video" type="text" class="form-control input display-7" style="width: 300px;display: block; margin-left: auto; margin-right: auto;"  name="txtVideo" value="${Cuadros[3].getVideo()}"/>
                            </div>
                            <div class="card-box">
                                <h4 class="card-title py-3 mbr-fonts-style display-5" style="text-align: center" >Subtitulo</h4>
                                <form:input path="Subtitulo" type="text" class="form-control input display-7" style="width: 300px;display: block; margin-left: auto; margin-right: auto;"  name="txtImagen" value="${Cuadros[3].getSubtitulo()}"/>
                                <h4 class="card-title py-3 mbr-fonts-style display-5" style="text-align: center" >Texto actual</h4>
